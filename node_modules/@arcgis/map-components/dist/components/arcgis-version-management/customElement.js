...
import { once as y, watch as V } from "@arcgis/core/core/reactiveUtils.js";
import E from "@arcgis/core/versionManagement/VersionManager.js";
...
class O extends S {
  ...
  async load() {
    y(() => this.viewModel.state === "ready").then(() => {
  ...
  render() {
    ...
    return f`<div class="root"><calcite-flow custom-item-selectors="arcgis-version-management-version-list, arcgis-version-management-version-properties" class=${L(this.mode === "dialog" ? "" : "component-container-flow")} ${N(this.flowElement)}><calcite-flow-item .closable=${this.closable} .heading=${c ?? void 0} @calciteFlowItemClose=${() => this._handleFlowItemClose()} .selected=${!g}>${I}<calcite-panel class="service-items-panel" .loading=${h === "loading" || h === "executing"}>${_}${x}</calcite-panel></calcite-flow-item></calcite-flow></div>`;
  }
}
k("arcgis-version-management", O);
export {
