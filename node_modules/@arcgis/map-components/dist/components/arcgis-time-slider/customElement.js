...
class _ extends s {
  ...
  async updateWebDocument(e) {
    this.widget?.updateWebDocument(e);
  }
  loaded() {
    this.manager.onLifecycle(() => d(() => this.viewModel.view?.ready, () => {
      this.timeExtent && this.viewModel.view && (this.viewModel.view.timeExtent = this.timeExtent);
    }, { initial: !0 }));
  }
}
i("arcgis-time-slider", _);
export {
  _ as ArcgisTimeSlider
};
