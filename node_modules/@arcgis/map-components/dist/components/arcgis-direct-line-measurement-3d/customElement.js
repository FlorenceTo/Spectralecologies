...
import { css as w, html as g } from "lit";
import { LitElement as f, createEvent as v, nothing as b, safeClassMap as x } from "@arcgis/lumina";
...
import { b as M } from "../../chunks/async-utils.js";
import { g as p } from "../../chunks/globalCss.js";
import { V as u } from "../../chunks/visible-element.js";
import O from "@arcgis/core/analysis/DirectLineMeasurementAnalysis.js";
import { isAboveGeodesicDistanceThreshold as V } from "@arcgis/core/applications/Components/analysisUtils.js";
...
var j = Object.defineProperty, B = Object.getOwnPropertyDescriptor, a = (t, e, r, o) => {
  for (var i = o > 1 ? void 0 : o ? B(e, r) : e, n = t.length - 1, c; n >= 0; n--)
    (c = t[n]) && (i = (o ? c(e, r, i) : c(i)) || i);
...
let s = class extends U {
  ...
  get state() {
    const { analysis: t, disabled: e, operationState: r, ready: o, supported: i } = this, { valid: n } = t;
    return L({ supported: i, disabled: e, ready: o, operationState: r, valid: n });
  }
  get displayState() {
    return C(this.state, !!this.analysis.startPoint);
  }
  get measurement() {
    const t = this.analysisView?.result, e = t?.mode ?? "euclidean";
    if (!this.analysis.valid)
      return {
        mode: e,
        directDistance: d(void 0),
        horizontalDistance: d(void 0),
        verticalDistance: d(void 0)
      };
    const r = t?.directDistance, o = r != null && V(r);
    return {
      mode: e,
      directDistance: d(o ? void 0 : r),
      horizontalDistance: d(t?.horizontalDistance),
      verticalDistance: d(t?.verticalDistance)
    };
  }
  get unitOptions() {
  ...
  get unit() {
    return P(this._userUnit, this.analysis.unit, this.unitOptions, this.defaultMeasurementSystem);
  }
  set unit(t) {
    this._userUnit = t;
  }
...
a([
  l({ readOnly: !0 })
], s.prototype, "displayState", 1);
a([
  l({ readOnly: !0 })
], s.prototype, "measurement", 1);
a([
  l()
], s.prototype, "unitOptions", 1);
a([
  l()
], s.prototype, "_userUnitOptions", 2);
a([
  l()
], s.prototype, "unit", 1);
a([
  l()
], s.prototype, "_userUnit", 2);
s = a([
...
class Z extends f {
  ...
  render() {
    const { messages: e, unit: r, unitOptions: o, viewModel: i } = this, { measurement: n, state: c } = i;
    return g`<div aria-label=${e.componentLabel ?? b} class=${x(z("root", p.widget, p.panel))} role=presentation><arcgis-measurement-content .state=${i.displayState} .hintLabel=${e.hint} .unsupportedLabel=${e.unsupported} .items=${[
      {
        title: e.direct,
        measurement: n.directDistance
      },
      {
        title: e.horizontal,
        measurement: n.horizontalDistance
      },
      {
        title: e.vertical,
        measurement: n.verticalDistance
      }
      ...
      this.unit = h.detail;
    }}></arcgis-unit-select>` })}${u({ hidden: this.hideStartButton, children: g`<calcite-button slot=actions .disabled=${c === "disabled" || c === "unsupported"} @click=${this.start}>${e.newMeasurement}</calcite-button>` })}</arcgis-measurement-content></div>`;
  }
}
_("arcgis-direct-line-measurement-3d", Z);
export {
  Z as ArcgisDirectLineMeasurement3d
};
