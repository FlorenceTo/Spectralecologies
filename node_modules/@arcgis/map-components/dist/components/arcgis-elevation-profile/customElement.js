...
import { createChart as U } from "@arcgis/core/applications/Components/analysisUtils.js";
...
import { LitElement as k, createEvent as M, nothing as u, safeClassMap as v } from "@arcgis/lumina";
...
let s = class extends z {
  ...
  get doneButtonAvailable() {
    ...
    return j(t) && t.paths.length > 0 && t.paths[0].length > 2;
  }
  ...
  set feature(t) {
    t ? t !== this.feature && (this.analysis.setGeometryFromFeature(t), this._selectedFeature = t) : this._selectedFeature = void 0;
  }
  get featureIsSelected() {
    return this.feature != null;
  }
  get hasVertices() {
    return H(this.analysis);
  }
  ...
  get state() {
    return this.disabled || !this.ready ? "disabled" : this._selectingPromise ? "selecting" : this.operationState === "active" ? "creating" : this.analysis.valid ? this.featureIsSelected ? "selected" : "created" : "ready";
  }
  get distanceUnit() {
    return _(
      this._userDistanceUnit,
      this.analysis.displayUnits?.distance,
      this.distanceUnitOptions,
      this.defaultMeasurementSystem
    );
  }
  set distanceUnit(t) {
    this._userDistanceUnit = t;
  }
  get distanceUnitOptions() {
    return w(this._userDistanceUnitOptions);
  }
  set distanceUnitOptions(t) {
    this._userDistanceUnitOptions = t;
  }
  get elevationUnit() {
    return _(
      this._userElevationUnit,
      this.analysis.displayUnits?.elevation,
      this.elevationUnitOptions,
      this.defaultMeasurementSystem
    );
  }
  set elevationUnit(t) {
    this._userElevationUnit = t;
  }
  get elevationUnitOptions() {
    return w(this._userElevationUnitOptions);
  }
  set elevationUnitOptions(t) {
    this._userElevationUnitOptions = t;
  }
  //#endregion
    ...
    this.addHandles([
      g(
        () => ({
          ...
          unitDistance: this._userDistanceUnit,
          unitElevation: this._userElevationUnit
        }),
        ({ analysis: t, unitDistance: e, unitElevation: i }) => {
          i && (t.displayUnits.elevation = i), e && (t.displayUnits.distance = e);
        },
        { sync: !0, initial: !0 }
      ),
      g(
  ...
  async select() {
    ...
    const e = super.start({
      operation: async (i) => {
        ...
        i?.signal?.aborted || (t.interactive = !1, this.feature = r.feature);
      },
      clear: !1
    });
    e.finally(() => {
  ...
  clearAnalysis() {
    this.geometry = null, this.elevationInfo = null, this.feature = void 0;
  }
  ...
  _removeSelectionHighlight() {
    this._selectionHighlightTask?.value?.remove(), this._selectionHighlightTask = E(this._selectionHighlightTask);
  }
...
o([
  a()
], s.prototype, "_userDistanceUnit", 2);
o([
  a()
], s.prototype, "_userDistanceUnitOptions", 2);
o([
  a()
], s.prototype, "_userElevationUnit", 2);
o([
  a()
], s.prototype, "_userElevationUnitOptions", 2);
o([
  a()
...
o([
  a()
], s.prototype, "feature", 1);
o([
  a()
], s.prototype, "featureIsSelected", 1);
o([
  a({ readOnly: !0 })
], s.prototype, "hasVertices", 1);
o([
  a()
], s.prototype, "highlightDisabled", 2);
o([
  a()
], s.prototype, "indicatorRelativePosition", 1);
o([
  a()
...
class J extends k {
  ...
  load() {
    this.manager.onLifecycle(() => [
      g(() => ({ container: this._chartContainer }), ({ container: e }) => {
        this._destroyChart(), e && (this._chartInitializationTask = b(async (i) => await U({
  ...
  _getErrorMessage() {
    const e = K[this.viewModel.errorState];
  ...
  render() {
    return c`<div aria-label=${this._messages.componentLabel ?? u} class=${v({
      root: !0,
      [f.widget]: !0,
  ...
  _renderContentForReadyState() {
    const { _messages: e, hideSelectButton: i, hideStartButton: r } = this, { selectButtonAvailable: n } = this.viewModel, l = !i && n;
    let d;
    return !r && l ? d = e.readyPrompt : r ? l ? d = e.readyPromptSelectOnly : d = e.errors?.noProfile : d = e.readyPromptCreateOnly, this._renderContent({ prompt: d, chart: !1, actions: p });
  }
  ...
  _renderContentForSelectedState() {
    ...
    return e ? this._renderContent({ chart: !1, actions: p, prompt: e }) : this._renderContent({ chart: !0, actions: p });
  }
  ...
  _renderZoomOutButton() {
    ...
    return c`<calcite-action icon=magnifying-glass-minus @click=${this._onZoomOutButtonClick} .text=${e} title=${e ?? u}></calcite-action>`;
  }
  _renderChart() {
    if (this.hideChart)
      return;
  ...
  _renderSpinner(e) {
    ...
    return c`<calcite-loader class=${v({
      ...
      small: i,
      visible: r
    })} .inline=${i} label></calcite-loader>`;
  }
  _renderClearButton() {
    const e = this._messages.clearProfile ?? "";
    return c`<calcite-action icon=trash @click=${this._onClearButtonClick} .text=${e} title=${e ?? u}></calcite-action>`;
  }
  _renderLegend() {
    return c`<arcgis-elevation-profile-legend .effectiveDisplayUnits=${this.viewModel.effectiveDisplayUnits} .featureSelected=${this.viewModel.featureIsSelected} .messages=${this._messages} .results=${this.viewModel.results}></arcgis-elevation-profile-legend>`;
  }
  _renderSettingsButton() {
    return c`<arcgis-elevation-profile-settings .viewModel=${this.viewModel} .hideUniformChartScalingToggle=${this.hideUniformChartScalingToggle} .hideDistanceDisplayUnitSelect=${this.hideDistanceDisplayUnitSelect} .hideElevationDisplayUnitSelect=${this.hideElevationDisplayUnitSelect} .messages=${this._messages} .uniformChartScaling=${this.viewModel.uniformChartScaling} .unitOptionsDistance=${this.viewModel.distanceUnitOptions} .unitOptionsElevation=${this.viewModel.elevationUnitOptions} @arcgisElevationProfileSettingsUniformChartScalingChange=${(e) => {
...
const p = [{ type: "select" }, { type: "sketch" }], K = {
  none: void 0,
...
x("arcgis-elevation-profile", J);
export {
  J as ArcgisElevationProfile
};
