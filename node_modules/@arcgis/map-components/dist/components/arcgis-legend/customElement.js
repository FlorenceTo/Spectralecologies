...
import { on as o, watch as s } from "@arcgis/core/core/reactiveUtils.js";
...
class b extends g {
  ...
  static {
    this.properties = { _isCardStyle: 16, view: 0, referenceElement: 1, icon: 1, activeLayerInfos: 0, basemapLegendVisible: 5, headingLevel: 9, hideLayersNotInCurrentView: 5, respectLayerDefinitionExpression: 5, ignoreLayerVisibility: 5, layerInfos: 0, loading: 39, cardStyleLayout: 1, legendStyle: 1, autoDestroyDisabled: 5, messageOverrides: 0, label: 1, state: 32 };
  }
  static {
    this.styles = w;
  }
  get ignoreLayerVisibility() {
    return !this.viewModel.respectLayerVisibility;
  }
  set ignoreLayerVisibility(e) {
  ...
  loaded() {
    this.manager.onLifecycle(() => [
      ...
      s(() => [
        ...
        typeof this.legendStyle == "object" ? this.legendStyle.layout : void 0
      ], () => {
        const e = this.legendStyle, i = typeof e == "object" ? e : { type: e };
        this._isCardStyle = i.type === "card", this._isCardStyle ? (this.cardStyleLayout = this.cardStyleLayout || i.layout || "auto", this.cardStyleLayout === "auto" && this.el.closest("arcgis-expand") && (this.cardStyleLayout = "stack"), this.setAttribute("card-style-layout", this.cardStyleLayout)) : this.removeAttribute("card-style-layout");
      }, { initial: !0 })
    ]);
  }
  _refreshActiveLayerInfos(e) {
    e.forEach((i) => {
      this.final.removeHandles(`version_${i.layer.uid}`), this._renderOnActiveLayerInfoChange(i);
    }), this.requestUpdate();
  }
  render() {
    return r`<div class=${p(u("root", a.widget, { [a.panel]: !this._isCardStyle }))}>${this._isCardStyle && this.view ? r`<arcgis-legend-card-view .activeLayerInfos=${this.activeLayerInfos} .headingLevel=${this.headingLevel} .messages=${this.messages} .layout=${this.cardStyleLayout} .view=${this.view}></arcgis-legend-card-view>` : r`<arcgis-legend-classic-view .activeLayerInfos=${this.activeLayerInfos} .headingLevel=${this.headingLevel} .messages=${this.messages}></arcgis-legend-classic-view>`}</div>`;
  }
  _renderOnActiveLayerInfoChange(e) {
    const i = s(() => e.version, () => this.requestUpdate());
