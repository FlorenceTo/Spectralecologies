...
class _ extends l {
  ...
  updateFromRendererResult(i, r) {
    return this.widget.updateFromRendererResult(i, r);
  }
}
t("arcgis-slider-color-legacy", _);
export {
  _ as ArcgisSliderColorLegacy
};
