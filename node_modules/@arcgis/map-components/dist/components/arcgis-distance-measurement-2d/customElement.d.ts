...
import type DistanceMeasurementAnalysis from "@arcgis/core/analysis/DistanceMeasurementAnalysis.js";
...
import type { DistanceMeasurement2DState } from "./types.js";
...
/**
 * The Distance Measurement 2D component can be added to an [arcgis-map](https://developers.arcgis.com/javascript/latest/references/map-components/components/arcgis-map/)
 ...
 * @since 4.28
 */
export abstract class ArcgisDistanceMeasurement2d extends LitElement {
  /**
   * The [DistanceMeasurementAnalysis](https://developers.arcgis.com/javascript/latest/references/core/analysis/DistanceMeasurementAnalysis/)
   ...
   * @since 5.0
   */
  accessor analysis: DistanceMeasurementAnalysis;
  /**
   ...
   */
  get state(): DistanceMeasurement2DState;
  /**
   * Unit system (imperial, metric) or specific unit used for displaying the distance values. Possible values are listed in
   * [unitOptions](https://developers.arcgis.com/javascript/latest/references/map-components/components/arcgis-distance-measurement-2d/#unitOptions).
   */
   ...
   * Possible [unit](https://developers.arcgis.com/javascript/latest/references/map-components/components/arcgis-distance-measurement-2d/#unit) values can only be a subset of this list.
   */
