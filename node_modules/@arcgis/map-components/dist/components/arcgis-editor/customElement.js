...
class g extends a {
  ...
  async startMergeFeaturesWorkflow(e, i) {
    await this.widget?.startMergeFeaturesWorkflow(e, i);
  }
  async startSplitFeatureWorkflow(e, i) {
    await this.widget?.startSplitFeatureWorkflow(e, i);
  }
  async startUpdateFeaturesWorkflow(e) {
    await this.widget?.startUpdateFeaturesWorkflow(e);
  }
