...
import U from "@arcgis/core/rest/networks/support/NetworkElement.js";
...
class R extends Q {
  ...
  render() {
    const { _state: t } = this;
    return p`<div class="root"><arcgis-feature-element-info .heading=${this.heading} .headingLevel=${this.headingLevel} .description=${this.description}></arcgis-feature-element-info>${t === "loading" ? this._renderLoading() : t === "disabled" ? this._renderAssociationNotFound() : this._renderContent()}</div>`;
  }
