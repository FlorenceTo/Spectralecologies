...
class p extends a {
  ...
  async _loadUtilityNetwork() {
    if (this.el.view?.map && this.el.view.map.portalItem) {
      ...
      const e = this.el.view.map.utilityNetworks?.getItemAt(0);
      await e?.load(), this.utilityNetwork = e;
    }
  }
}
t("arcgis-utility-network-validate-topology", p);
export {
  p as ArcgisUtilityNetworkValidateTopology
};
