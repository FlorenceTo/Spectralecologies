...
class c extends s {
  ...
  async generateWhereClause(e) {
    return this.widget.generateWhereClause(e);
  }
}
i("arcgis-histogram-range-slider", c);
export {
  c as ArcgisHistogramRangeSlider
};
