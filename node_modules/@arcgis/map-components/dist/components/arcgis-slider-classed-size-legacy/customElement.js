...
import t from "@arcgis/core/widgets/smartMapping/ClassedSizeSlider.js";
...
class h extends l {
  ...
  async updateClassBreakInfos(e) {
    return this.widget.updateClassBreakInfos(e);
  }
  async updateFromRendererResult(e, r) {
    return this.widget.updateFromRendererResult(e, r);
  }
}
s("arcgis-slider-classed-size-legacy", h);
export {
  h as ArcgisSliderClassedSizeLegacy
};
