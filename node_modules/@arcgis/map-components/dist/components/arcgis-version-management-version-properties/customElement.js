...
import { createRef as u, ref as f } from "lit/directives/ref.js";
import { LitElement as $, createEvent as d } from "@arcgis/lumina";
const x = V`:host{display:none;background:#bdf2c4}:host([selected]){display:flex}.properties-buttons{display:flex}`;
class I extends $ {
  constructor() {
  ...
  _handleChange(e) {
    ...
    switch (i === "create" && (s || (s = {
      ...
      case "calciteChipGroupSelect": {
        const n = e.target.label, o = e.target.selectedItems[0].label;
        i === "create" && (s = { ...s, [n]: o }), i === "edit" && (c = { ...c, [n]: o });
        break;
      }
      case "calciteInputTextInput": {
        const n = e.target.name, o = e.target.value;
        i === "create" && (s = { ...s, [n]: o }), i === "edit" && (c = { ...c, [n]: o });
        break;
      }
