...
class g extends c {
  ...
  _renderAuthorSection() {
    return this._showAuthorInput ? t`<div><calcite-label>${this.messages.author}<calcite-input .value=${this.viewModel.templateOptions.author ?? ""} @calciteInputInput=${(e) => this.viewModel.templateOptions.author = e.target.value}></calcite-input></calcite-label></div>` : null;
  }
  _renderCopyrightSection() {
    return this._showCopyrightInput ? t`<div><calcite-label>${this.messages.copyright}<calcite-input .value=${this.viewModel.templateOptions.copyright ?? ""} @calciteInputInput=${(e) => this.viewModel.templateOptions.copyright = e.target.value}></calcite-input></calcite-label></div>` : null;
  }
  _renderDpiSection() {
  ...
  _renderLegendSection() {
    return this._showLegendInput ? t`<div><calcite-label layout=inline><calcite-checkbox .checked=${!!this.viewModel.templateOptions.legendEnabled} @calciteCheckboxChange=${(e) => this.viewModel.templateOptions.legendEnabled = e.target.checked}></calcite-checkbox>${this.messages.legend}</calcite-label>${this.viewModel.templateOptions.legendEnabled ? t`<calcite-label layout=inline><calcite-checkbox .checked=${!!this.viewModel.templateOptions.dynamicLegendEnabled} @calciteCheckboxChange=${(e) => this.viewModel.templateOptions.dynamicLegendEnabled = e.target.checked}></calcite-checkbox>${this.messages.dynamicLegend}</calcite-label>` : null}</div>` : null;
  }
...
n("arcgis-print-layout-advanced-options", g);
export {
