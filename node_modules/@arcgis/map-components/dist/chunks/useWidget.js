...
import { proxyExports as v, getControllersCount as w, trackPropKey as b } from "@arcgis/lumina/controllers";
import { AccessorController as y, getAccessorControllerBoundProperties as E, makeBinderProxy as g } from "@arcgis/lumina/controllers/accessor";
import { isEsriInternalEnv as x } from "@arcgis/toolkit/error";
...
class p extends y {
  ...
  constructor(e, t) {
    ...
    if (i.#t = o, i.instance = r, i.exports = r, n) {
      ...
      E(i).set("viewModel", "viewModel"), e.addController(s), n = g(e, new WeakRef(s), w(e) - 1, n, i.#o);
    }
  ...
  hostLoaded() {
    ...
    e.childElem ??= document.createElement("div"), e.childElem.setAttribute("arcgis-widget-wrapped", ""), this.instance.container = e.childElem, (this.component.el.shadowRoot ?? this.component.el).appendChild(this.instance.container), this.component.closed !== void 0 && this.onLifecycle(() => m(() => this.instance.visible, (i) => this.component.closed = !i, { initial: !0 }));
  }
  #i(e) {
...
process.env.NODE_ENV !== "production" && x() && (p.devOnly$allowedPropNameMismatches = /* @__PURE__ */ new Set([
  "manager",
  "el",
  "multipleSortEnabled",
  // Deprecated
