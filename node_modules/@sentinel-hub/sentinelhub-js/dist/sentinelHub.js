...
const DATASET_CDAS_S3SLSTRL2 = {
    id: 'CDAS_S3SLSTRL2',
    shJsonGetCapabilitiesDataset: 'S3SLSTRL2',
    shWmsEvalsource: 'S3SLSTRL2',
    shProcessingApiDatasourceAbbreviation: 'S3SLSTRL2',
    datasetParametersType: 'S3SLSTR',
    shServiceHostname: 'https://sh.dataspace.copernicus.eu/',
    orbitTimeMinutes: 50.495,
...
const DATASET_CDAS_OTC_S3SLSTRL2 = {
    id: 'CDAS_S3SLSTRL2',
    shJsonGetCapabilitiesDataset: 'S3SLSTRL2',
    shWmsEvalsource: 'S3SLSTRL2',
    shProcessingApiDatasourceAbbreviation: 'S3SLSTRL2',
...
const DATASET_CDAS_L8_L9_LOTL1 = {
    id: 'CDAS_L8_L9_LOTL1',
    shJsonGetCapabilitiesDataset: 'LOTL1',
    shWmsEvalsource: 'L8',
...
const DATASET_CDAS_OTC_L8_L9_LOTL1 = {
    id: 'CDAS_L8_L9_LOTL1',
    shJsonGetCapabilitiesDataset: 'LOTL1',
    shWmsEvalsource: 'L8',
    shProcessingApiDatasourceAbbreviation: 'landsat-ot-l1',
...
class Landsat89CDASLOTL1Layer extends AbstractLandsat8Layer {
    constructor() {
        super(...arguments);
        this.dataset = DATASET_CDAS_L8_L9_LOTL1;
    }
    getPreviewUrl(productId) {
        return `https://landsatlook.usgs.gov/gen-browse?size=thumb&type=refl&product_id=${productId}`;
    }
...
class S3SLSTRL2CDASLayer extends S3SLSTRLayer {
    constructor() {
        super(...arguments);
        this.dataset = DATASET_CDAS_S3SLSTRL2;
    }
}
...
class LayersFactory {
    static matchDatasetFromGetCapabilities(datasetId, baseUrl) {
        ...
        return matchingDatasetIds.find((dataset) => {
            ...
            if (providedHost === SHV3_LOCATIONS_ROOT_URL[LocationIdSHv3.awsEuCentral1] &&
...
LayersFactory.LAYER_FROM_DATASET_V3 = {
    ...
    [DATASET_CDAS_S3SLSTRL2.id]: S3SLSTRL2CDASLayer,
    [DATASET_CDAS_OTC_S3SLSTRL2.id]: S3SLSTRL2CDASLayer,
