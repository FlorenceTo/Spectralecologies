...
class LayersFactory {
    static matchDatasetFromGetCapabilities(datasetId, baseUrl) {
        ...
        return matchingDatasetIds.find((dataset) => {
            ...
            if (providedHost === SHV3_LOCATIONS_ROOT_URL[exports.LocationIdSHv3.awsEuCentral1] &&
                datasetHost === SHV3_LOCATIONS_ROOT_URL[exports.LocationIdSHv3.awsUsWest2]) {
                return true;
            }
...
exports.DATASET_CDAS_L8_L9_LOTL1 = DATASET_CDAS_L8_L9_LOTL1;
...
exports.DATASET_CDAS_S3SLSTRL2 = DATASET_CDAS_S3SLSTRL2;
...
exports.Landsat89CDASLOTL1Layer = Landsat89CDASLOTL1Layer;
...
exports.S3SLSTRL2CDASLayer = S3SLSTRL2CDASLayer;
